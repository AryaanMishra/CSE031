...
char* append(char s1[], char s2[]){
    ...
    s1[k + s1len] = '\0';  // TO FIX add null terminator
...
int main() {
    char str1[10]; //TO FIX replace 10 with a grerater number to allocate more memory for the string.
    char str2[10]; //TO FIX replace 10 with a grerater number to allocate more memory for the string.
